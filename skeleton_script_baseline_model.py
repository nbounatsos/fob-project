...
def parse_blosum(path):
    ...
    #aas is a list containing all the names of AA (20)
    #aa_scores is a 2 dimension list containing all the scores for all the AA (20x20)
    #blosum_dict is a 2 dimension dictionary containing the names of AA as keys and another empty dictionary as value 
    ...
    with open(path, "rb") as f:
        ...
        for line in f:
            ...
            if line.startswith('#'):
                ...
                ref_aas.append(vars.split('/')[0])
                mut_aas.append(vars.split('/')[1])
